...
public class PlayerCrouchState : PlayerBaseState
{
    ...
    public override void StateUpdate(PlayerStatesManager player)
    {
        ...
        {
            case 1: _spriteTransform.localScale = new Vector3(_spriteTransform.localScale.x, _spriteTransform.localScale.y *2); Walking(0, player.playerRigidbody2D.velocity.y); player.SwitchState(player.airState); break;
